"""Generated from Baileys/src/WAM/constants.ts."""

WEB_EVENTS = [{'name': 'WamDroppedEvent',
  'id': 4358,
  'props': {'droppedEventCode': [1, 'integer'], 'droppedEventCount': [2, 'integer'], 'isFromWamsys': [3, 'boolean']},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'MetaVerifiedInteraction',
  'id': 4870,
  'props': {'businessOwnerJid': [1, 'string'],
 ...
 {'name': 'LwiEntryPointImpression',
  'id': 2906,
  'props': {'businessToolsSessionId': [2, 'string'],
 ...
 {'name': 'EphemeralSyncResponseSend',
  'id': 4778,
  'props': {'clientDisappearingModeInitiator': [1,
                                                {'CHAT': 1,
                                                 'INITIATED_BY_ME': 2,
            ...
            'esrEphemeralityInitiator': [8,
                                         {'INITIATED_BY_ME': 1, 'INITIATED_BY_OTHER': 2, 'BIZ_UPGRADE_FB_HOSTING': 3}],
 ...
 {'name': 'ChatMute',
  'id': 2280,
  'props': {'actionConducted': [3, {'MUTE': 1, 'UNMUTE': 2, 'EXPIRE': 3}],
            'chatMuteNotificationChoice': [5, {'NO_NOTIFICATIONS_WHEN_MUTED': 1, 'YES_NOTIFICATIONS_WHEN_MUTED': 2}],
            'muteChatType': [4, {'ONE_ON_ONE': 1, 'GROUP': 2, 'CHANNEL': 3, 'INTEROP': 4, 'INORGANIC_NOTIFICATION': 5}],
 ...
 {'name': 'CoexPrivacySysMsg',
  'id': 5204,
  'props': {'coexStatusReplyPrivacyDisclaimerUserAction': [8, {'DISPLAYED': 1, 'TAPPED': 2}],
            ...
            'coexSysMsgStateTransitionAttempt': [7, {'E2EE_TO_HOSTED': 0, 'HOSTED_TO_E2EE': 1, 'HOSTED_TO_HOSTED': 2}]},
  'wamChannel': 'private',
  'privateStatsIdInt': 113760892,
  'weight': 1},
 {'name': 'E2eMessageSend',
  'id': 476,
  'props': {'agentEngagementType': [15, {'DIRECT_CHAT': 0, 'INVOKED': 1, 'MEMBER': 2}],
            'botType': [17,
                        {'UNKNOWN': 0, 'METABOT': 1, 'BOT_1P_BIZ': 2, 'BOT_3P_BIZ': 3, 'UGC': 4, 'META_CHARACTER': 5}],
            ...
            'e2eDestination': [4, {'INDIVIDUAL': 0, 'GROUP': 1, 'LIST': 2, 'STATUS': 3, 'CHANNEL': 4, 'INTEROP': 5}],
            'e2eFailureReason': [2,
                                 {'INVALID_MESSAGE': 0,
                                  'LEGACY_MESSAGE': 1,
                                  'INVALID_VERSION': 2,
 ...
 {'name': 'SignCredential',
  'id': 2242,
  'props': {'applicationState': [6, {'FOREGROUND': 1, 'BACKGROUND': 2}],
 ...
 {'name': 'WaFsSingleEmojiMessageDaily',
  'id': 5602,
  'props': {'animatedEmojiEnabled': [1, 'boolean'],
 ...
 {'name': 'MexEventV2',
  'id': 4336,
  'props': {'mexEventV2DurationMs': [1, 'timer'],
 ...
 {'name': 'BotJourney',
  ...
  'props': {'actionType': [1,
            ...
            'aiCreationInputType': [29, {'SUGGESTION': 1, 'USER_INPUT': 2, 'USER_INPUT_AND_SUGGESTION': 3}],
            ...
            'appSessionId': [2, 'string'],
            'botDiscoveryPath': [8, {'CURATED_DISPLAY': 1, 'SEARCH': 2, 'VIEW_ALL': 3, 'DEEPLINK_USER_SHARED': 4}],
            'botEntryPoint': [7,
                              {'WA_CHAT': 1,
                               'STATUS': 2,
                               'NEW_CHAT': 3,
 ...
 {'name': 'SearchTheWebFunnel',
  'id': 5702,
  'props': {'imageSearchFailedErrorType': [5,
                                           {'NON_200_RESPONSE': 0,
                                            'NON_302_RESPONSE': 1,
 ...
 {'name': 'VideoTranscoder',
  'id': 1802,
  'props': {'sourceAudioBitRate': [12, 'number'],
 ...
 {'name': 'SyncdKeyCount',
  'id': 3978,
  'props': {'keysUsedInSnapshotCount': [1, 'integer'],
 ...
 {'name': 'Ptt',
  'id': 458,
  'props': {'isMetaAiThread': [15, 'boolean'],
 ...
 {'name': 'ChannelDiscoveryVisibilityTracking',
  'id': 5766,
  'props': {'channelCategoryIndex': [1, 'integer'],
            'channelCategoryName': [2, 'string'],
            'channelDirectorySessionId': [3, 'integer'],
            'channelEventUnit': [4, {'RECOMMENDED_CHANNELS': 1, 'SIMILAR_CHANNELS': 2, 'RECENT_SEARCHES': 3}],
 ...
 {'name': 'UpdatesTabSearch',
  'id': 4838,
  'props': {'channelsAdminCount': [5, 'integer'],
  ...
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'BusinessUnmute', 'id': 1378, 'props': {'muteeId': [1, 'string']}, 'wamChannel': 'regular', 'weight': 1},
 {'name': 'MdBootstrapAppStateCriticalDataProcessing',
  'id': 3164,
  'props': {'bootstrapAppStateDataStage': [1,
                                           {'REQUEST_BUILT': 1,
                                            'RESPONSE_RECEIVED': 2,
 ...
 {'name': 'PsGroupSafetyCheckSheetSeen',
  'id': 6240,
  'props': {'integrityGroupUserHashedId': [2, 'string'], 'psSafetyCheckGroupJid': [1, 'string']},
  'wamChannel': 'private',
  'privateStatsIdInt': 216763284,
  'weight': 1},
 {'name': 'ChannelCoreEvent',
  'id': 4692,
  'props': {'channelCoreEventSequenceNumber': [8, 'integer'],
            ...
            'channelEventUnit': [12, {'RECOMMENDED_CHANNELS': 1, 'SIMILAR_CHANNELS': 2, 'RECENT_SEARCHES': 3}],
            'cid': [4, 'string'],
 ...
 {'name': 'WebcFingerprint',
  'id': 1704,
  'props': {'browserEngine': [26, {'BLINK': 0, 'GECKO': 1, 'WEBKIT': 2, 'UNKNOWN': 3}],
 ...
 {'name': 'DisappearingMessageKeepInChat',
  'id': 3482,
  'props': {'canEditDmSettings': [16, 'boolean'],
 ...
 {'name': 'WebcMediaEditorSend',
  'id': 2890,
  'props': {'blurImageCount': [7, 'integer'],
 ...
 {'name': 'WebContactListStartNewChat',
  'id': 4560,
  'props': {'webContactListStartNewChatSearch': [1, 'boolean'],
 ...
 {'name': 'WebcButterbarEvent',
  'id': 3932,
  'props': {'webcButterbarAction': [1, {'IMPRESSION': 1, 'CLICK_CTA': 2, 'CLICK_DISMISS': 3, 'AUTO_DISMISS': 4}],
            'webcButterbarType': [2,
                                  {'OFFLINE': 1,
                                   'RESUME_CONNECTING': 2,
 ...
 {'name': 'WebcSocketConnect',
  'id': 5450,
  'props': {'webcAuthHandshakeDuration': [1, 'timer'],
 ...
 {'name': 'DisappearingModeSettingChange',
  'id': 3056,
  'props': {'disappearingModeEntryPoint': [4,
                                           {'ACCOUNT_SETTINGS': 1,
                                            'SYSTEM_MESSAGE': 2,
 ...
 {'name': 'DeepLinkClick',
  'id': 1156,
  'props': {'deepLinkHasPhoneNumber': [2, 'boolean'],
 ...
 {'name': 'PsGroupOpened',
  'id': 6236,
  'props': {'integrityGroupUserHashedId': [4, 'string'],
 ...
 {'name': 'DeepLinkConversion',
  'id': 1432,
  'props': {'callInitiator': [8, {'BUSINESS': 0, 'CONSUMER': 1}],
 ...
 {'name': 'EditBusinessProfile',
  'id': 1466,
  'props': {'businessProfileEntryPoint': [10,
                                          {'REGISTRATION': 1,
                                           'SETTINGS': 2,
                                           'COMPLIANCE': 3,
 ...
 {'name': 'PsGroupExitExperienceGroupAction',
  'id': 6332,
  'props': {'psGroupExitExperienceAction': [1, {'GROUP_DELETED': 0, 'GROUP_EXITED': 1}],
 ...
 {'name': 'WebcLinkPreviewDisplay',
  'id': 3864,
  'props': {'didFallbackNonHq': [2, 'boolean'],
 ...
 {'name': 'MdRetryFromUnknownDevice',
  'id': 2178,
  'props': {'offline': [2, 'boolean'], 'senderType': [1, {'PRIMARY': 1, 'COMPANION': 2}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'PinInChatMessageSend',
  'id': 4438,
  'props': {'groupRole': [1, {'ADMIN': 1, 'MEMBER': 2}],
            'groupTypeClient': [2, {'REGULAR_GROUP': 1, 'SUB_GROUP': 2, 'DEFAULT_SUB_GROUP': 3, 'PARENT_GROUP': 4}],
            'isAGroup': [3, 'boolean'],
 ...
 {'name': 'InlineVideoPlaybackClosed',
  'id': 2032,
  'props': {'inlineVideoCancelBeforePlayStateT': [7, 'timer'],
 ...
 {'name': 'ChannelDirectory',
  'id': 4544,
  'props': {'channelCategoryIndex': [11, 'integer'],
            ...
            'channelDirectorySessionId': [3, 'integer'],
            'channelDirectorySurface': [13, {'CHANNEL_DIRECTORY_CATEGORIES': 1, 'CHANNEL_DIRECTORY': 2}],
 ...
 {'name': 'PrivacyHighlightDaily',
  'id': 3522,
  'props': {'dialogAppearCount': [1, 'integer'],
 ...
 {'name': 'NotificationSetting',
  'id': 3684,
  'props': {'groupReactionNotification': [1, 'boolean'],
 ...
 {'name': 'WebcQplHealth',
  'id': 3134,
  'props': {'webcQplHealthEventData': [1, 'string'],
 ...
 {'name': 'StickerError',
  'id': 5024,
  'props': {'stickerErrorType': [1, {'DECOMPRESSION': 2, 'SENDER_VALIDATION': 3, 'RECEIVER_VALIDATION': 4}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'MessageContextMenuActions',
  'id': 3694,
  'props': {'isAGroup': [1, 'boolean'],
 ...
 {'name': 'GroupProfilePicture',
  'id': 3652,
  'props': {'groupCreationDs': [1, 'string'],
 ...
 {'name': 'WebcMediaAnalyzed',
  'id': 912,
  'props': {'webcMediaAnalyzeT': [3, 'timer'],
 ...
 {'name': 'NotificationEngagement',
  'id': 3796,
  'props': {'avgNotifEngagementT': [1, 'timer'],
            'groupSizeBucket': [2,
                                {'SMALL': 1,
                                 'MEDIUM': 2,
                                 'LARGE': 3,
                                 ...
                                 'LT5000': 14,
                                 'LARGEST_BUCKET': 15}],
            'groupTypeClient': [3, {'REGULAR_GROUP': 1, 'SUB_GROUP': 2, 'DEFAULT_SUB_GROUP': 3, 'PARENT_GROUP': 4}],
            'isAGroup': [4, 'boolean'],
 ...
 {'name': 'MessageSend',
  'id': 854,
  'props': {'agentEngagementType': [49, {'DIRECT_CHAT': 0, 'INVOKED': 1, 'MEMBER': 2}],
            ...
            'ephemeralityInitiator': [47, {'INITIATED_BY_ME': 1, 'INITIATED_BY_OTHER': 2, 'BIZ_UPGRADE_FB_HOSTING': 3}],
 ...
 {'name': 'StickerCommonQueryToStaticServer',
  'id': 2740,
  'props': {'httpResponseCode': [2, 'integer'],
            'params': [3, 'string'],
 ...
 {'name': 'PaidMessagingUserInteractionsLogger',
  ...
  'props': {'pmxActionTarget': [1,
            ...
            'pmxHeaderMediaType': [4, {'TEXT': 0, 'IMAGE': 1, 'VIDEO': 2, 'LOCATION': 3, 'DOCUMENT': 4, 'GIF': 5}],
 ...
 {'name': 'WebcProgressiveImage',
  'id': 2226,
  'props': {'webcFirstRenderScans': [1, 'integer'],
 ...
 {'name': 'CrashLog',
  'id': 494,
  'props': {'activeSubfunnelId': [20, 'string'],
 ...
 {'name': 'PsStructuredMessageInteraction',
  'id': 3052,
  'props': {'bizPlatform': [1, {'UNKNOWN': 1, 'SMB': 2, 'ENT': 3, 'CLOUDAPI': 4}],
 ...
 {'name': 'DeepLinkMsgSent',
  'id': 3198,
  'props': {'deepLinkAction': [1, {'MSG_SENT': 1}], 'deepLinkSessionId': [2, 'string']},
  'wamChannel': 'regular',
  'weight': 1},
 ...
 {'name': 'MediaUpload2',
  ...
  'props': {'appContext': [63, 'string'],
            ...
            'overallMediaKeyReuse': [40, {'NONE_NEW_CONTENT': 1, 'NONE_EXPIRED': 2, 'REUSED': 3, 'NONE_WAS_STATUS': 4}],
            ...
            'pairedMediaType': [62,
                                {'SD_PHOTO': 0,
                                 ...
                                 'MOTION_PHOTO_PARENT': 4,
                                 'MOTION_PHOTO_CHILD': 5}],
            'photoQualitySetting': [52, {'AUTO': 0, 'DATA_SAVER': 1, 'HIGH_QUALITY': 2, 'HIGHEST_QUALITY': 3}],
            ...
            'videoQualitySetting': [54, {'AUTO': 0, 'DATA_SAVER': 1, 'HIGH_QUALITY': 2, 'HIGHEST_QUALITY': 3}]},
  'wamChannel': 'regular',
  'weight': 1},
 ...
 {'name': 'AutomaticEventsUserJourney',
  'id': 6636,
  'props': {'automaticEventsTargetComponent': [1,
                                               {'SYSTEM_MESSAGE': 0,
                                                'LEARN_MORE': 1,
                                                'NUX_SCREEN': 2,
                                                'NUX_SCREEN_OK': 3,
 ...
 {'name': 'CtwaConsumerDisclosure',
  'id': 4406,
  'props': {'ctwaConsumerDisclosureVersion': [3, 'integer'],
            'disclosureAction': [1,
                                 {'SCREEN_VIEW': 0,
                                  'CLICK_ON_CONTINUE': 1,
                                  'CANCEL': 2,
            ...
            'disclosureContext': [5,
                                  {'PREFILL_TEXT': 0, 'EMPTY_PREFILL_TEXT': 1, 'ICEBREAKERS': 2, 'NOT_APPLICABLE': 3}],
 ...
 {'name': 'MessageDeleteActions',
  'id': 3626,
  'props': {'deleteActionType': [1, {'DELETE_FOR_ME': 0, 'DELETE_FOR_EVERYONE': 1}],
            'isAGroup': [2, 'boolean'],
            'mediaType': [6,
                          {'NONE': 1,
                           'PHOTO': 2,
 ...
 {'name': 'WebcLogin',
  'id': 1664,
  'props': {'webcBrowserNetworkType': [14, 'string'],
 ...
 {'name': 'MdBootstrapHistoryDataStartDownloading',
  'id': 4650,
  'props': {'historySyncChunkOrder': [1, 'integer'],
 ...
 {'name': 'ReportingTokenValidationFailureSender',
  'id': 6094,
  'props': {'clientMessageId': [1, 'string'],
 ...
 {'name': 'Ctwa3pdConversion',
  'id': 5138,
  'props': {'ctwa3pdConversionMetadata': [1, 'string'],
 ...
 {'name': 'BusinessToolsImpression',
  'id': 2220,
  'props': {'businessToolsEntryPoint': [4,
                                        {'ENTRY_BANNER': 0,
 ...
 {'name': 'UnknownStanza',
  'id': 3448,
  'props': {'unknownStanzaTag': [1, 'string'], 'unknownStanzaType': [2, 'string']},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'PrivacyTipAction',
  'id': 4794,
  'props': {'privacyTipActionType': [1, {'VIEW': 1, 'CLICK_PRIVACY_TIP': 2, 'CLICK_OK': 3, 'CLICK_OUTSIDE': 4}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'WebcLinkPreviewResponseHandle',
  'id': 3860,
  'props': {'didRespondHqPreview': [5, 'boolean'],
 ...
 {'name': 'OrderDetailsActionsSmb',
  'id': 3456,
  'props': {'acceptedPayMethods': [1, 'string'],
 ...
 {'name': 'CtwaLabelSignal',
  'id': 4662,
  'props': {'ctwaLabelSignalVersion': [1, 'integer'],
 ...
 {'name': 'WebcChatCreate',
  'id': 6132,
  'props': {'creationMethod': [1, {'MISSING_WHEN_SAVING_MESSAGE': 0}], 'noCreated': [2, 'integer']},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'MdChatAssignmentSecondaryAction',
  'id': 3716,
  'props': {'mdChatAssignmentSecondaryActionAgentId': [1, 'string'],
 ...
 {'name': 'BugReportSession',
  'id': 3850,
  'props': {'bugReportErrorMessage': [2, 'string'],
 ...
 {'name': 'WebcMenu',
  'id': 2504,
  'props': {'webcMenuAction': [2, {'THREADS_SCREEN_CLICK': 1, 'CHAT_SCREEN_CLICK': 2, 'SETTINGS_SCREEN_CLICK': 3}],
            'webcMenuItemLabel': [3,
                                  {'NEW_GROUP': 1,
                                   'CREATE_A_ROOM': 2,
                                   'PROFILE': 3,
 ...
 {'name': 'SettingsClick',
  'id': 2214,
  'props': {'isBookmarkAppInstalled': [4, 'boolean'],
 ...
 {'name': 'KeepInChatNux',
  'id': 3486,
  'props': {'chatEphemeralityDuration': [1, 'integer'],
            'kicNuxActionName': [2,
 ...
 {'name': 'TestAnonymousDailyId',
  'id': 2958,
  'props': {'psTestEnumField': [1, {'TEST_VALUE1': 1, 'TEST_VALUE2': 2}], 'psTestFloatField': [2, 'number']},
  'wamChannel': 'private',
  'privateStatsIdInt': 248614979,
  'weight': 1},
 {'name': 'WebcPageLoad',
  'id': 642,
  'props': {'webcAppcacheStatus': [29,
                                   {'UNCACHED': 0,
                                    'IDLE': 1,
                                    'CHECKING': 2,
                                    'DOWNLOADING': 3,
 ...
 {'name': 'PsGroupSafetyCheckUiInteractions',
  'id': 6242,
  'props': {'integrityGroupUserHashedId': [3, 'string'],
 ...
 {'name': 'WebcAssetLoad',
  'id': 1358,
  'props': {'webcAssetCacheType': [4, {'UNCACHED': 0, 'IDB': 1, 'SW': 2}],
 ...
 {'name': 'ChannelSimilarChannels',
  'id': 5202,
  'props': {'bannerStatus': [1, {'DISPLAYED': 0, 'HIDDEN': 1, 'CLOSED': 2}],
 ...
 {'name': 'OfflineResume',
  'id': 3112,
  'props': {'affectedBySleepMode': [35, 'boolean'],
 ...
 {'name': 'RevokeMessageSend',
  'id': 3656,
  'props': {'messageSendResultIsTerminal': [1, 'boolean'],
            'messageType': [2,
                            {'INDIVIDUAL': 1,
                             'GROUP': 2,
                             'BROADCAST': 3,
 ...
 {'name': 'UiMessageYourselfAction',
  'id': 3780,
  'props': {'uiMessageYourselfActionSessionId': [1, 'string'],
 ...
 {'name': 'DisappearingModeSettingEvents',
  'id': 3446,
  'props': {'disappearingModeEntryPoint': [5,
                                           {'ACCOUNT_SETTINGS': 1,
                                            'SYSTEM_MESSAGE': 2,
                                            'INDIVIDUAL_CHAT_DISAPPEARING_MESSAGES_SETTING': 3,
                                            'GROUP_CHAT_DISAPPEARING_MESSAGES_SETTING': 4,
  ...
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'GroupCreateC', 'id': 156, 'props': {}, 'wamChannel': 'regular', 'weight': 1},
 {'name': 'MdChatAssignment',
  'id': 3752,
  'props': {'assignerAgentId': [1, 'string'],
            'assignerBrowserId': [2, 'string'],
            'assignerMdId': [3, 'integer'],
            'chatAssignmentAction': [4, {'ACTION_ASSIGNED': 0, 'ACTION_UNASSIGNED': 1, 'ACTION_REASSIGNED': 2}],
 ...
 {'name': 'Daily',
  'id': 1158,
  'props': {'accessibilityVoiceover': [108, 'boolean'],
            ...
            'mediaQualitySetting': [188, {'AUTO': 0, 'DATA_SAVER': 1, 'HIGH_QUALITY': 2, 'HIGHEST_QUALITY': 3}],
 ...
 {'name': 'LidMigrationDaily',
  'id': 5842,
  'props': {'completedMigrations': [1, 'string'],
 ...
 {'name': 'CommunityTabAction',
  'id': 3496,
  'props': {'communityNoActionTabViews': [4, 'integer'],
 ...
 {'name': 'ContactUsSession',
  'id': 470,
  'props': {'contactUsAutomaticEmail': [3, 'boolean'],
 ...
 {'name': 'MarketingMessageUserControlsJourney',
  'id': 6070,
  'props': {'businessPhoneNumber': [9, 'integer'],
            'isSuccess': [1, 'boolean'],
 ...
 {'name': 'SettingsSearchTap',
  ...
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'WebWamForceFlush', 'id': 3264, 'props': {}, 'wamChannel': 'regular', 'weight': 1},
 {'name': 'PsGroupExitExperienceExitDialogInteraction',
  'id': 6318,
  'props': {'psExitExperienceReportingEnabled': [1, 'boolean'],
            'psGroupExitExperienceEnabled': [2, 'boolean'],
 ...
 {'name': 'SmbDataSharingConsentScreen',
  'id': 3972,
  'props': {'smbDataSharingConsentScreenEntryPoint': [3,
                                                      {'NEW_ORDER': 0,
                                                       'CART': 1,
                                                       'LABEL_CHAT': 2,
                                                       'LABEL_MESSAGE': 3,
 ...
 {'name': 'PttPlayback',
  ...
  'props': {'pttDuration': [12, 'timer'],
            ...
            'pttType': [6,
                        {'UNKNOWN': 0, 'AAC': 1, 'MP3': 2, 'AMR_NB': 3, 'AMR_WB': 4, 'OPUS': 5, 'MULTIPLE_TRACKS': 6}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'PsGroupSafetyCheckEnabled',
  'id': 6238,
  'props': {'didJoinByGil': [3, 'boolean'],
 ...
 {'name': 'WebcBackgroundSyncAdoption',
  'id': 5302,
  'props': {'offboardSource': [1, {'IN_APP_SETTING': 1, 'OS_SETTING': 2}],
            'onboardSource': [2,
                              {'DEFAULT': 1,
 ...
 {'name': 'GifSearchResultTapped',
  'id': 1122,
  'props': {'gifSearchProvider': [1, {'GIPHY': 0, 'TENOR': 1}], 'rank': [2, 'integer']},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'UserActivity',
  'id': 1384,
  'props': {'userActivityBitmapHigh': [4, 'integer'],
 ...
 {'name': 'ChatFolderOpen',
  'id': 2808,
  'props': {'activityIndicatorCount': [2, 'integer'],
            'folderType': [1, 'string'],
 ...
 {'name': 'E2eRetryReject',
  'id': 3578,
  'props': {'invisibleMessageCategory': [6,
                                         {'PEER': 1,
                                          'INVISIBLE_KEY_DISTRIBUTION': 2,
                                          'OTHER': 3,
                                          'MEDIA_EXPRESS_NOTIFY': 4,
 ...
 {'name': 'FmxAction',
  'id': 4444,
  'props': {'commonGroupNum': [1, 'integer'],
 ...
 {'name': 'WebcStatusSession',
  'id': 1880,
  'props': {'webcStatusMutedItemCount': [4, 'integer'],
 ...
 {'name': 'LabelEvent',
  'id': 1422,
  'props': {'customLabelTitle': [9, 'string'],
 ...
 {'name': 'BusinessInteraction',
  'id': 3450,
  'props': {'businessInteractionAction': [1, {'ACTION_CLICK': 1, 'ACTION_MSG_SENT': 2}],
 ...
 {'name': 'WebcNativeUpsellCta',
  'id': 3934,
  'props': {'webcNativeUpsellCtaEventType': [2, {'IMPRESSION': 1, 'CTA_BTN_CLICK': 2, 'CTA_DISMISS': 3}],
 ...
 {'name': 'WebDbTableUsage',
  'id': 5074,
  'props': {'offlineSessionId': [1, 'string'],
 ...
 {'name': 'TsExternal',
  'id': 4574,
  'props': {'relativeTimestampMs': [1, 'integer'],
 ...
 {'name': 'UiAction',
  'id': 472,
  'props': {'agentEngagementType': [9, {'DIRECT_CHAT': 0, 'INVOKED': 1, 'MEMBER': 2}],
            ...
            'sizeBucket': [4,
                           {'LT32': 1,
                            ...
                            'LT5000': 14,
                            'LARGEST_BUCKET': 15}],
            'uiActionChatType': [7, {'INDIVIDUAL': 1, 'GROUP': 2, 'SUBGROUP': 3, 'DEFAULT_SUBGROUP': 4, 'CHANNEL': 5}],
 ...
 {'name': 'CtwaActionBannerUnderstand',
  'id': 3586,
  'props': {'bannerIdentifier': [1, 'string'],
 ...
 {'name': 'TestAnonymousWeeklyId',
  'id': 2956,
  'props': {'psTestBooleanField': [2, 'boolean'],
 ...
 {'name': 'WebcMediaLoad',
  'id': 1202,
  'props': {'webcMediaLoadResult': [2, {'SUCCESS': 0, 'SILENCE': 1, 'ZEROWIDTH': 2}], 'webcMediaLoadT': [1, 'timer']},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'MdBadDeviceSentMessage',
  'id': 2176,
  'props': {'dsmError': [2, {'INVALID_SENDER': 1, 'MISSING_DSM': 2, 'INVALID_DSM': 3}],
            'editType': [3,
                         {'NOT_EDITED': 0,
                          'EDITED': 1,
                          'SENDER_REVOKE': 2,
 ...
 {'name': 'LimitSharingSettingUpdate',
  'id': 6390,
  'props': {'threadId': [1, 'string'], 'toggleUpdateAction': [2, {'TURN_ON': 0, 'TURN_OFF': 1}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'LwiEntryTap',
  'id': 2770,
  'props': {'businessToolsSessionId': [4, 'string'],
 ...
 {'name': 'WebcMediaRmr',
  ...
  'props': {'messageMediaType': [10,
            ...
            'webcChatType': [9, {'INDIVIDUAL': 0, 'GROUP': 1, 'BROADCAST_LIST': 2, 'COMMUNITY': 3, 'NEWSLETTER': 4}],
 ...
 {'name': 'MediaPicker',
  'id': 1038,
  'props': {'audienceSelectorClicked': [24, 'boolean'],
            ...
            'photoQualitySetting': [27, {'AUTO': 0, 'DATA_SAVER': 1, 'HIGH_QUALITY': 2, 'HIGHEST_QUALITY': 3}],
            'pickerSessionId': [30, 'integer'],
            'statusRecipients': [17, 'integer'],
            'transformCount': [52, 'integer'],
            'videoQualitySetting': [28, {'AUTO': 0, 'DATA_SAVER': 1, 'HIGH_QUALITY': 2, 'HIGHEST_QUALITY': 3}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'PollsActions',
  'id': 3676,
  'props': {'chatType': [8, {'OTHER': 0, 'INDIVIDUAL': 1, 'GROUP': 2, 'STATUS': 3, 'BROADCAST': 4, 'CHANNEL': 5}],
            'groupSizeBucket': [1,
                                {'SMALL': 1,
                                 'MEDIUM': 2,
                                 'LARGE': 3,
 ...
 {'name': 'ChatLockDaily',
  'id': 4214,
  'props': {'folderChatsCount': [1, 'integer'],
 ...
 {'name': 'ChannelLinkShare',
  'id': 4728,
  'props': {'channelLinkShareDirection': [1, {'WHATSAPP': 1, 'STATUS': 2, 'EXTERNAL': 3, 'QR_CODE': 4}],
 ...
 {'name': 'GatedChatOpened',
  'id': 3150,
  'props': {'chatGatedReason': [1, {'TOS3': 1, 'COUNTRY': 2}], 'selfInitiated': [2, 'boolean']},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'OfflineResumeStage',
  'id': 3536,
  'props': {'attemptId': [13, 'integer'],
 ...
 {'name': 'MdBootstrapHistorySyncStatusAfterPairing',
  'id': 4652,
  'props': {'activeTimeAfterPairing': [1, {'MINS_10': 1, 'MINS_20': 2, 'MINS_40': 3, 'MINS_60': 4, 'MINS_5': 5}],
 ...
 {'name': 'ChatAction',
  'id': 2312,
  'props': {'chatActionChatType': [3, {'INDIVIDUAL': 1, 'GROUP': 2, 'BUSINESS': 3, 'BROADCAST_LIST': 4}],
 ...
 {'name': 'SettingsSearchInitiate',
  'id': 4014,
  'props': {'settingsPageType': [1, {'SETTINGS': 0, 'ME_TAB': 1, 'AVATAR_COINFLIP': 2}]},
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'SmbUserJourney',
  'id': 5462,
 ...
 {'name': 'LwiScreen',
  'id': 2772,
  'props': {'adContentRecommendation': [41, {'REGULAR': 1, 'RECOMMENDED': 2}],
            ...
            'lwiDefaultTargetingSpec': [19,
                                        {'UNKOWN': 1, 'MATCHES_TARGETING_SPEC': 2, 'DIFFERS_FROM_TARGETING_SPEC': 3}],
 ...
 {'name': 'MdBootstrapHistoryDataReceived',
  'id': 2998,
  'props': {'historySyncChunkOrder': [6, 'integer'],
 ...
 {'name': 'PsChannelPostForward',
  'id': 4746,
  'props': {'channelForwardContentType': [6, {'UPDATE': 0, 'UPDATE_CARD': 1}],
 ...
 {'name': 'MdAppStateSyncDaily',
  'id': 2300,
  'props': {'crossIndexConflictCount': [11, 'integer'],
 ...
 {'name': 'ReportToAdminEvents',
  'id': 4420,
  'props': {'reportToAdminInteraction': [1,
 ...
 {'name': 'ChannelProducerInsightsNavigation',
  'id': 5626,
  'props': {'channelProducerInsightsActionTarget': [1,
                                                    {'REACH_TAB': 0,
                                                     'GROWTH_TAB': 1,
                                                     'FOLLOWERS_TAB': 2,
 ...
 {'name': 'BusinessToolsClick',
  'id': 2218,
  'props': {'businessToolsEntryPoint': [5,
                                        {'ENTRY_BANNER': 0,
                                         'ENTRY_REGISTRATION_ONBOARDING': 1,
                                         'ENTRY_CONVERSATIONS': 2,
                                         'ENTRY_SETTINGS': 3,
 ...
 {'name': 'StatusItemView',
  'id': 1658,
  'props': {'externalSourceDomainType': [34,
                                         {'FACEBOOK': 1,
                                          'FACEBOOK_WATCH': 2,
                                          'INSTAGRAM': 3,
                                          'YOUTUBE': 4,
            ...
            'reshareSource': [41, {'MENTIONS_RESHARE': 1, 'STATUS_RESHARE': 2, 'FORWARDED_FROM_STATUS': 3}],
            ...
            'statusRowSection': [11,
                                 {'RECENT_STORIES': 1,
                                  ...
                                  'WAMO_PREVIEW': 18}],
            'statusType': [36, {'IMAGE': 1, 'VIDEO': 2, 'GIF': 3, 'AUDIO': 4, 'TEXT': 5, 'MUSIC_STANDALONE': 6}],
 ...
 {'name': 'ChannelAdmin',
  'id': 4556,
  'props': {'adminFlowActionSequenceNumber': [1, 'integer'],
 ...
 {'name': 'PrivacySettingsClick',
  'id': 3726,
  'props': {'privacyControlEntryPoint': [1,
                                         {'PRIVACY_SETTINGS': 0,
                                          'PROFILE_PHOTO_JIT': 1,
                                          'SETTINGS_SEARCH': 2,
                                          'DEEP_LINK': 3,
 ...
 {'name': 'BotBizJourney',
  ...
  'props': {'appSessionId': [1, 'string'],
            ...
            'botBizEntryPoint': [6, {'SHARED_BOT_BIZ_CARD': 1, 'SHARED_BOT_BIZ_DEEPLINK': 2, 'BOT_BIZ_CHAT': 3}],
 ...
 {'name': 'PsGroupExitExperienceExitDeleteConfirmationDialogUiInteraction',
  'id': 6316,
  'props': {'psGroupExitExperienceDeleteConfirmationDialogAction': [1,
 ...
 {'name': 'PsPhoneNumberHyperlink',
  'id': 3266,
  'props': {'isPhoneNumHyperlinkOwner': [1, 'boolean'],
 ...
 {'name': 'NativeContactsNuxEvent',
  'id': 5788,
  'props': {'nativeContactsNuxEntryPoint': [3,
                                            {'UNKNOWN': 0,
                                             'NEW_CONTACT': 1,
                                             'CONTACT_HEADER': 2,
                                             'GROUP': 3,
 ...
 {'name': 'WebcChatOpen',
  'id': 864,
  'props': {'webcChatOpenBeforePaintT': [7, 'timer'],
 ...
 {'name': 'NonMessagePeerDataMediaUpload',
  'id': 3902,
  'props': {'peerDataErrorCount': [1, 'integer'],
 ...
 {'name': 'MessagingFavoritesUpdate',
  'id': 5460,
  'props': {'contactFavCountAfterUpdate': [1, 'integer'],
 ...
 {'name': 'LockFolderUnlock',
  'id': 4218,
  'props': {'landingSurface': [1, {'THREAD': 0, 'FOLDER': 1, 'CHAT_INFO': 2}],
 ...
 {'name': 'CompanionsContactEvent',
  'id': 5718,
  'props': {'companionAddContactActionType': [1,
 ...
 {'name': 'SettingsChange',
  'id': 6396,
  'props': {'currentSettingValue': [4, 'string'],
 ...
 {'name': 'Lid11MigrationLifecycle',
  'id': 6154,
  'props': {'chatNotInMappingCount': [1, 'integer'],
 ...
 {'name': 'MerchantCommerceEvent',
  'id': 4688,
  'props': {'acceptedPaymentMethods': [1, 'string'],
            'adId': [2, 'string'],
 ...
 {'name': 'AndroidMessageSendPerf',
  'id': 1994,
  'props': {'agentEngagementType': [47, {'DIRECT_CHAT': 0, 'INVOKED': 1, 'MEMBER': 2}],
  ...
  'wamChannel': 'regular',
  'weight': 2000},
 {'name': 'HfmTextSearchComplete', 'id': 2186, 'props': {}, 'wamChannel': 'regular', 'weight': 1},
 {'name': 'WamClientErrors',
  'id': 1144,
  'props': {'isFromWamsys': [27, 'boolean'],
 ...
 {'name': 'WebcStorageStat',
  'id': 1504,
  'props': {'webcAgeOfStorage': [3, 'integer'],
 ...
 {'name': 'PttDaily',
  'id': 2938,
  'props': {'pttCancelBroadcast': [9, 'integer'],
 ...
 {'name': 'SmbPaidMessagesButtonLogger',
  'id': 4508,
  'props': {'businessPhoneNumber': [1, 'integer'],
            'pmButtonCount': [2, 'integer'],
            'pmButtonEventType': [3, {'CLICK': 0}],
            'pmButtonIndex': [4, 'integer'],
            'pmButtonType': [5,
                             {'QUICK_REPLY': 0, 'CTA_URL': 1, 'CTA_CALL': 2, 'CTA_CATALOG': 3, 'CTA_CATALOG_ITEM': 4}],
 ...
 {'name': 'WebDbLoadFromVersionFailureNonAnonymous',
  'id': 4814,
  'props': {'webDbLoader': [1, {'MAIN': 1, 'WEB_WORKER': 2, 'SERVICE_WORKER': 3}],
            'webDbName': [2,
                          {'MODEL_STORAGE': 1,
                           'FTS_STORAGE': 2,
                           'JOBS_STORAGE': 3,
 ...
 {'name': 'SenderKeyExpired',
  'id': 3130,
  'props': {'chatType': [1, {'OTHER': 0, 'INDIVIDUAL': 1, 'GROUP': 2, 'STATUS': 3, 'BROADCAST': 4, 'CHANNEL': 5}],
            'deviceSizeBucket': [2,
                                 {'LT32': 1,
                                  'LT64': 2,
                                  'LT128': 3,
  ...
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'WaOldCode', 'id': 3940, 'props': {'deviceId': [1, 'string']}, 'wamChannel': 'regular', 'weight': 1},
 {'name': 'WebcMessageSend',
  'id': 2072,
  'props': {'messageIsForward': [3, 'boolean'],
            'messageMediaType': [2,
                                 {'NONE': 1,
                                  'PHOTO': 2,
                                  'VIDEO': 3,
 ...
 {'name': 'WebcMessageQuery',
  'id': 1876,
  'props': {'webcAudioMessageCount': [14, 'integer'],
            ...
            'webcChatType': [13, {'INDIVIDUAL': 0, 'GROUP': 1, 'BROADCAST_LIST': 2, 'COMMUNITY': 3, 'NEWSLETTER': 4}],
 ...
 {'name': 'MdAppStateSyncMutationStats',
  'id': 3180,
  'props': {'applied': [1, {'ZERO': 1, 'ONE': 2, 'LT10': 3, 'LT100': 4, 'LT500': 5, 'LT1K': 6, 'LT5K': 7, 'GTE5K': 8}],
            'failed': [2, {'ZERO': 1, 'ONE': 2, 'LT10': 3, 'LT100': 4, 'LT500': 5, 'LT1K': 6, 'LT5K': 7, 'GTE5K': 8}],
            'invalid': [3, {'ZERO': 1, 'ONE': 2, 'LT10': 3, 'LT100': 4, 'LT500': 5, 'LT1K': 6, 'LT5K': 7, 'GTE5K': 8}],
            'orphan': [4, {'ZERO': 1, 'ONE': 2, 'LT10': 3, 'LT100': 4, 'LT500': 5, 'LT1K': 6, 'LT5K': 7, 'GTE5K': 8}],
 ...
 {'name': 'WebcMinorEventLog',
  'id': 5440,
  'props': {'additionalDebugContext': [1, 'string'],
            'logContext': [2, 'string'],
            'logCount': [3, 'integer'],
            'logReason': [4, 'string'],
            'logType': [5,
 ...
 {'name': 'NonMessagePeerDataRequest',
  'id': 3906,
  'props': {'peerDataRequestCount': [1, 'integer'],
 ...
 {'name': 'AttachmentTrayActions',
  'id': 3980,
  'props': {'actionDurationMs': [1, 'integer'],
            'actionThreadType': [9,
                                 {'GROUP_CHAT': 1,
                                  'P2P_THREAD': 2,
                                  'MESSAGE_YOURSELF': 3,
 ...
 {'name': 'MessageReceive',
  'id': 450,
  'props': {'agentEngagementType': [28, {'DIRECT_CHAT': 0, 'INVOKED': 1, 'MEMBER': 2}],
            ...
            'ephemeralityInitiator': [26, {'INITIATED_BY_ME': 1, 'INITIATED_BY_OTHER': 2, 'BIZ_UPGRADE_FB_HOSTING': 3}],
 ...
 {'name': 'WebcOfflineNotificationProcess',
  'id': 4222,
  'props': {'currentOfflineProcessStage': [4,
                                           {'PAGE_LOAD': 1,
                                            'SOCKET_CONNECT': 2,
                                            'OFFLINE_PREVIEW': 3,
                                            'PROCESSING': 4,
 ...
 {'name': 'CommunityCreation',
  'id': 3492,
  'props': {'communityCreationActionCount': [1, 'integer'],
 ...
 {'name': 'DisappearingMessageChatPicker',
  'id': 3398,
  'props': {'chatsSelected': [1, 'integer'],
            'dmChatPickerEntryPoint': [2, {'DEFAULT_MODE_SETTING': 0, 'STORAGE_SETTING': 1, 'PRIVACY_SETTING': 2}],
 ...
 {'name': 'ChatMessageCounts',
  'id': 1644,
  'props': {'aiChatOrigins': [224, {'UNKNOWN': 0, 'AI_HOME': 1, 'AI_TAB_TEXT': 2, 'AI_TAB_VOICE': 3}],
            ...
            'chatMuted': [8, {'NOT_MUTED': 1, 'MUTED_NO_NOTIFICATIONS': 2, 'MUTED_SILENT_NOTIFICATIONS': 3}],
            'chatOrigins': [179, {'LID_USERNAME': 1, 'LID_CTWA': 2, 'OTHERS': 3}],
            'chatOverflowClicks': [79, 'integer'],
            'chatTypeInd': [2, {'INDIVIDUAL': 1, 'SMB': 2, 'ENT': 3, 'INTEROP': 4, 'UNKNOWN': 5, 'BUSINESS': 6}],
 ...
 {'name': 'WebcResourceLoad',
  'id': 688,
  'props': {'webcResourceCached': [3, 'boolean'],
 ...
 {'name': 'CtwaOrderSignal',
  'id': 4264,
  'props': {'ctwaOrderSignalVersion': [1, 'integer'],
 ...
 {'name': 'WebDbVersionsSource',
  'id': 4784,
  'props': {'webDbVersionSource': [1, {'KNOB': 1, 'LOCAL': 2, 'STATIC': 3, 'KNOB_WITH_LOCAL_OVERRIDE': 4}],
 ...
 {'name': 'BusinessToolsEntry',
  'id': 2216,
  'props': {'businessToolsEntryPoint': [3,
                                        {'ENTRY_BANNER': 0,
                                         'ENTRY_REGISTRATION_ONBOARDING': 1,
                                         'ENTRY_CONVERSATIONS': 2,
                                         'ENTRY_SETTINGS': 3,
 ...
 {'name': 'ForwardSend',
  'id': 1728,
  'props': {'disappearingChatInitiator': [21,
                                          {'CHAT': 1,
                                           'INITIATED_BY_ME': 2,
                                           'INITIATED_BY_OTHER': 3,
                                           'CHAT_PICKER': 4,
            ...
            'ephemeralityInitiator': [24, {'INITIATED_BY_ME': 1, 'INITIATED_BY_OTHER': 2, 'BIZ_UPGRADE_FB_HOSTING': 3}],
 ...
 {'name': 'CommunityHomeAction',
  'id': 3494,
  'props': {'communityHomeGroupDiscoveries': [1, 'integer'],
 ...
 {'name': 'StatusReportingEvents',
  'id': 3920,
  'props': {'statusReportInteraction': [1,
                                        {'CLICK_REPORT': 0,
 ...
 {'name': 'IncomingMessageDrop',
  'id': 3724,
  'props': {'agentEngagementType': [12, {'DIRECT_CHAT': 0, 'INVOKED': 1, 'MEMBER': 2}],
            'botType': [14,
                        {'UNKNOWN': 0, 'METABOT': 1, 'BOT_1P_BIZ': 2, 'BOT_3P_BIZ': 3, 'UGC': 4, 'META_CHARACTER': 5}],
            'e2eCiphertextType': [1,
                                  {'MESSAGE': 0,
                                   ...
                                   'SENDER_KEY_MESSAGE': 2,
                                   'MESSAGE_SECRET_MESSAGE': 3}],
            'e2eDestination': [2, {'INDIVIDUAL': 0, 'GROUP': 1, 'LIST': 2, 'STATUS': 3, 'CHANNEL': 4, 'INTEROP': 5}],
            'e2eFailureReason': [9,
                                 {'INVALID_MESSAGE': 0,
                                  'LEGACY_MESSAGE': 1,
                                  'INVALID_VERSION': 2,
 ...
 {'name': 'ReceiptStanzaReceive',
  ...
  'props': {'dbReadsCount': [12, 'integer'],
            ...
            'receiptAggregation': [11, {'NONE': 0, 'MULTI_MESSAGES': 1, 'MULTI_PARTICIPANTS': 2, 'AGGREGATE_BY_ID': 3}],
 ...
 {'name': 'WaShopsManagement',
  'id': 2908,
  'props': {'isShopsProductPreviewVisible': [2, 'boolean'],
 ...
 {'name': 'MediaDownload2',
  'id': 1590,
  'props': {'activeThreadCount': [55, 'integer'],
            'aiFetchMediaType': [62,
                                 {'IMAGE_SINGLE': 1,
                                  'GRID_HIGH_RES': 2,
                                  'GRID_LOW_RES': 3,
 ...
 {'name': 'SupportAiSession',
  ...
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'WebDynamicSamplingTestEventWithSampling', 'id': 5320, 'props': {}, 'wamChannel': 'regular', 'weight': 10000},
 {'name': 'WebcFtsStorage',
  'id': 3642,
 ...
 {'name': 'SmbDataSharingConsentSetting',
  'id': 3974,
  'props': {'smbDataSharingConsentSettingEntryPoint': [1,
 ...
 {'name': 'WhatsappQuickPromotionClientEligibilityWaterfall',
  'id': 4360,
  'props': {'clientExtraData': [6, 'string'],
 ...
 {'name': 'MdSyncdDogfoodingFeatureUsage',
  'id': 3016,
  'props': {'mdSyncdDogfoodingFeature': [1,
                                         {'PIN_MUTATION': 1,
 ...
 {'name': 'ChannelOpen',
  'id': 4316,
  'props': {'channelDirectorySessionId': [8, 'integer'],
            'channelEntryPoint': [1,
                                  {'UNKNOWN': 0,
                                   'UPDATES_TAB': 1,
                                   'DIRECTORY': 2,
 ...
 {'name': 'KeepInChatNotif',
  'id': 3484,
  'props': {'kicGroupNotificationTaps': [3, 'integer'],
 ...
 {'name': 'MediaStreamPlayback',
  'id': 1584,
  'props': {'bytesDownloadedStart': [4, 'number'],
 ...
 {'name': 'BusinessMute',
  ...
  'wamChannel': 'regular',
  'weight': 1},
 {'name': 'WebDynamicSamplingTestEventWithoutSampling', 'id': 5322, 'props': {}, 'wamChannel': 'regular', 'weight': 1},
 {'name': 'UserNotice',
  'id': 2472,
  'props': {'noticeTriggeredBy': [5, {'AUTO_START': 0, 'BANNER': 1, 'DEEP_LINK': 2, 'JUST_IN_TIME': 3}],
 ...
 {'name': 'SuspendedGroupDelete',
  'id': 4342,
  'props': {'deleteBtnSource': [1, {'BOTTOM_SHEET_BTN': 1, 'BLOCKED_COMPOSER_BTN': 2}]},
  'wamChannel': 'private',
  'privateStatsIdInt': 0,
  'weight': 1},
 ...
 {'name': 'UserNoticeError',
  'id': 2474,
  'props': {'noticeType': [4, {'LEGACY_USER_NOTICE': 0, 'BADGED_USER_NOTICE': 1, 'PDFN_DISCLOSURE': 2}],
            'userNoticeContentVersion': [2, 'integer'],
 ...
 {'name': 'QuickReply',
  'id': 1468,
  'props': {'attachmentGifCount': [7, 'integer'],
 ...
 {'name': 'CadminDemote',
  'id': 3426,
  'props': {'cadminDemoteOrigin': [1, {'PROMOTION_NOTIFICATION': 1, 'MEMBER_LIST': 2}],
 ...
 {'name': 'BannerEvent',
  'id': 1578,
  'props': {'bannerId': [3, 'string'],
            'bannerOperation': [2, {'SHOWN': 1, 'CLICK': 2, 'DISMISS': 3, 'ELIGIBLE': 4, 'REVOKED': 5, 'RENDERED': 6}],
            'bannerType': [1,
                           {'GROUP': 1,
                            'SMB_WELCOME': 2,
                            'SMB_VERIFIED': 3,
 ...
 {'name': 'MetaVerifiedUserAction',
  'id': 4986,
  'props': {'metaVerifiedQuickPromotionId': [12, 'string'],
            ...
            'metaVerifiedUserActionErrorDetails': [8, {'IQ_REQUEST_FAILED': 1, 'INELIGIBLE': 2, 'USER_CANCELLED': 3}],
...
WEB_GLOBALS = [{'name': 'abKey2', 'id': 4473, 'type': 'string', 'channels': ['regular']},
 {'name': 'appBuild',
  'id': 1657,
  'type': {'DEBUG': 1, 'ALPHA': 2, 'BETA': 3, 'RELEASE': 4},
  'channels': ['regular', 'private']},
 {'name': 'appIsBetaRelease', 'id': 21, 'type': 'boolean', 'channels': ['regular', 'private']},
 {'name': 'appVersion', 'id': 17, 'type': 'string', 'channels': ['regular', 'private']},
 {'name': 'beaconSessionId', 'id': 18529, 'type': 'integer', 'channels': ['regular']},
 ...
 {'name': 'deviceClassification',
  ...
  'type': {'MOBILE': 0,
           ...
           'UNDEFINED': 100},
  'channels': ['regular']},
 {'name': 'deviceName', 'id': 13, 'type': 'string', 'channels': ['regular', 'private']},
 {'name': 'deviceVersion', 'id': 4505, 'type': 'string', 'channels': ['regular']},
 {'name': 'expoKey', 'id': 5029, 'type': 'string', 'channels': ['regular', 'private']},
 {'name': 'isInCohort', 'id': 19129, 'type': 'boolean', 'channels': ['regular']},
 {'name': 'mcc', 'id': 5, 'type': 'integer', 'channels': ['regular', 'private']},
 {'name': 'memClass', 'id': 655, 'type': 'integer', 'channels': ['regular', 'private']},
 ...
 {'name': 'ocVersion', 'id': 6251, 'type': 'integer', 'channels': ['regular', 'private']},
 {'name': 'osVersion', 'id': 15, 'type': 'string', 'channels': ['regular', 'private']},
 {'name': 'platform',
  'id': 11,
  'type': {'IPHONE': 1,
           'ANDROID': 2,
 ...
 {'name': 'serviceImprovementOptOut', 'id': 13293, 'type': 'boolean', 'channels': ['regular', 'private']},
 {'name': 'streamId', 'id': 3543, 'type': 'integer', 'channels': ['regular', 'private']},
 {'name': 'wametaLoggerTestFilter', 'id': 15881, 'type': 'string', 'channels': ['regular', 'private']},
 {'name': 'webcBucket', 'id': 875, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcEnv', 'id': 633, 'type': {'PROD': 0, 'INTERN': 1, 'DEV': 2, 'E2E': 3}, 'channels': ['regular']},
 {'name': 'webcNativeAutolaunch', 'id': 1009, 'type': 'boolean', 'channels': ['regular']},
 {'name': 'webcNativeBetaUpdates', 'id': 1007, 'type': 'boolean', 'channels': ['regular']},
 {'name': 'webcPhoneAppVersion', 'id': 1005, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcPhoneCharging', 'id': 783, 'type': 'boolean', 'channels': ['regular']},
 {'name': 'webcPhoneDeviceManufacturer', 'id': 829, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcPhoneDeviceModel', 'id': 831, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcPhoneOsBuildNumber', 'id': 833, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcPhoneOsVersion', 'id': 835, 'type': 'string', 'channels': ['regular']},
 ...
 {'name': 'webcWebDeviceManufacturer', 'id': 6599, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcWebDeviceModel', 'id': 6601, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcWebOsReleaseNumber', 'id': 6603, 'type': 'string', 'channels': ['regular']},
 {'name': 'webcWebPlatform',
  ...
  'type': {'WEB': 1,
           ...
           'WIN_HYBRID': 11},
  'channels': ['regular', 'private']},
 {'name': 'yearClass', 'id': 689, 'type': 'integer', 'channels': ['regular', 'private']},
 {'name': 'yearClass2016', 'id': 2617, 'type': 'integer', 'channels': ['regular', 'private']},
 {'name': 'commitTime', 'id': 47, 'type': 'integer', 'channels': ['regular', 'private']},
 {'name': 'sequenceNumber', 'id': 3433, 'type': 'integer', 'channels': ['regular', 'private']}]
